...
const envSchema = z.object({
  ...
  API_PROTHEUS_FINANCE_URL: z.string('A variável API_PROTHEUS_FINANCE_URL é obrigatória'),
  API_PROTHEUS_DATA_URL: z.string('A variável API_PROTHEUS_DATA_URL é obrigatória'),
})
