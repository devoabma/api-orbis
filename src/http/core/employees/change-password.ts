    ...
    .put(
      '/auth/change-password',
      {
        schema: {
          ...
          response: {
            200: z.null().describe('Senha alterada com sucesso'),
          },
        },
      },
      async (request, reply) => {
        ...
        try {
          ...
          request.log.error({ err: error }, 'Erro ao alterar senha')
          throw new BadRequestError('Erro ao alterar senha. Por favor, tente novamente.')
        }
      }
    )
}
