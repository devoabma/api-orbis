...
z.locales.pt() // Configura o Zod para usar as mensagens de erro em português
...
app.register(multipart, {
  limits: { fileSize: 5 * 1024 * 1024 }, // exemplo: máximo 5MB
})

app.register(appRoutes)

// Inicia o job de fechamento automático de sessões
